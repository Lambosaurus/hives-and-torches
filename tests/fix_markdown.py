...
def run_all_checks(directory, verbosity, fix_links):
    checked = 0
    passed = 0
    for path in all_markdown_files(directory):
        if check_links(path, verbosity, fix_links) == 0:
            passed += 1
        checked += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fix-links", help="Fix links in markdown files.", type=bool, default=False)
